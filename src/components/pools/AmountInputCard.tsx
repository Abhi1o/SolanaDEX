                ...
                <input
                  ...
                  className={`w-full pr-20 md:pr-20 pl-4 py-4 min-h-[56px] bg-white/5 border ${
                    validationErrors.amountA
                      ? 'border-red-500/50'
                      : 'border-white/10'
                  } rounded-2xl text-white text-lg md:text-2xl font-light placeholder-white/30 focus:outline-none focus:border-blue-500/50 focus:bg-white/8 focus:ring-3 focus:ring-blue-500/10 transition-all`}
                  role="spinbutton"
